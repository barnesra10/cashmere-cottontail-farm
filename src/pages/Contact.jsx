...
export default function Contact() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // In production, this would POST to a Supabase edge function or Netlify/Cloudflare function
    // For now, we'll show success and you can wire up the backend
  ...
  return (
    <>
      <SEO
        title="Contact Us"
        description="Get in touch with Cashmere Cottontail Farm. Inquire about available animals, join our waiting list, or ask about organic produce."
        path="/contact"
      />
      ...
      <section className="bg-charcoal-700 plaid-bg text-white">
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16 text-center">
          <h1 className="font-display text-3xl md:text-4xl font-bold">
            Get In <span className="font-script text-wheat-400 font-normal">Touch</span>
          </h1>
          <p className="mt-3 font-body text-cream-200/80">
            Questions about our animals? Want to join a waiting list? We'd love to hear from you.
          </p>
        </div>
      </section>
        ...
        <div className="grid md:grid-cols-5 gap-10">
                ...
                <div className="space-y-5">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input type="text" name="name" value={form.name} onChange={handleChange} required
                        className="w-full px-4 py-2.5 bg-cream-50 border border-cream-200 rounded-xl text-charcoal-600 font-body text-sm focus:outline-none focus:ring-2 focus:ring-sage-300 focus:border-sage-300" />
                    </div>
                    <div>
                  ...
                  <div>
                    ...
                    <textarea name="message" value={form.message} onChange={handleChange} required rows={5}
                      className="w-full px-4 py-2.5 bg-cream-50 border border-cream-200 rounded-xl text-charcoal-600 font-body text-sm focus:outline-none focus:ring-2 focus:ring-sage-300 focus:border-sage-300 resize-none"
                      placeholder="Tell us about what you're looking for..." />
                  </div>
                  <button onClick={handleSubmit}
                    className="inline-flex items-center gap-2 bg-sage-500 hover:bg-sage-600 text-white font-semibold px-8 py-3 rounded-full transition-colors shadow-md hover:shadow-lg">
          ...
          <div className="md:col-span-2 space-y-6">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-body text-xs text-charcoal-400">Click the chat bubble in the bottom right for instant answers about our animals and farm.</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-body text-xs text-charcoal-400">We typically respond within 24 hours.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-wheat-50 rounded-2xl p-6 border border-wheat-200">
              ...
              <p className="font-body text-xs text-charcoal-400 mb-3">
                Stay updated on new arrivals, farm life, and availability.
              </p>
